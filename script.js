document.addEventListener('DOMContentLoaded', function() {
    ...
    function switchSection(sectionId) {
        ...
        if (targetSection) {
            ...
            // Restart text animation if returning to home
            if (sectionId === 'home') {
    ...
    function initTextAnimation() {
        ...
        if (!additionalText) {
            console.log('Additional text element not found');
            return;
        }
        
        // Start the reveal animation after 2.5 seconds
        setTimeout(() => {
            additionalText.classList.add('show');
        }, 2500);
    }
    
    // Restart text animation when returning to home
